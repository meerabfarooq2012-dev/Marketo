...
> = {
  ...
  vol9ch05p3: {
    file: 'data/math-formulas-vol9-ch05p3.json',
    basketSource: 'math-formulas-vol9-ch05p3',
    label:
      'Mathematics Formula Encyclopedia — Volume 9 Chapter 5 Part 3 (Vector Calculus: Vector Fields, Line Integrals, Fundamental Theorem for Line Integrals, Green Theorem, Curl and Divergence, Parametric Surfaces, Surface Integrals, Stokes Theorem, Divergence Theorem, Applications and Unification, Conservation Laws and PDEs, Worked Problems)',
    topicPrefix: 'math_vol9_',
  },
}
